...
class SearchMoviePagingAdapter(val listener:OnMovieItemClickListener): PagingDataAdapter<Movie, SearchMoviePagingAdapter.SearchMovieViewHolder>(DiffUtilCallBack) {
